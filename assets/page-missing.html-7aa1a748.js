import{_ as n,B as s,C as a,a7 as e}from"./framework-cb0d5945.js";const i={},p=e(`<h1 id="翻译缺失" tabindex="-1"><a class="header-anchor" href="#翻译缺失" aria-hidden="true">#</a> 翻译缺失</h1><p>将默认语言的文档作为未翻译语言的兜底文档。</p><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>此插件目前只在 <code>onInitialized</code> 钩子调用，它不会创建真实的文件只是复制当前页面的信息创建一个新的页面。</p></div><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> i <span class="token parameter variable">-D</span> @bfehub/vuepress-plugin-page-missing@1.60.x
