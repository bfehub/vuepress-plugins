import{K as n,L as s,M as a,N as e}from"./chunk-X6HE2CCA.21a3c316.js";const p={},t=e(`<h1 id="页面映射" tabindex="-1"><a class="header-anchor" href="#页面映射" aria-hidden="true">#</a> 页面映射</h1><p>通常在编写组件的文档的时候我们可能会把组件的文档直接和组件的实现放在一起，这时候 VuePress 不能很好的处理路径。</p><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> i <span class="token parameter variable">-D</span> @bfehub/vuepress-plugin-page-map
